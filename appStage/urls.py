...
urlpatterns = [
    ...
    path('rh/planification/', views.planifier_stages, name='planifier_stages'),
    path('rh/planification/<int:candidature_id>/finaliser/', views.finaliser_stage_candidature, name='finaliser_stage_candidature'),
